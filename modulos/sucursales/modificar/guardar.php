...
if($validacion){
	$resultado=$Osucursal->actualizar($nombre,$calle,$numero,$colonia,$cp,$ciudad,$estado,$telefonocontacto,$licenciassa,$serie,$folio,$idcuentacorreo,$archivofirma,$estatus, $idsucursal);
	if($resultado=="exito"){
		/*CARGAR ARCHIVOS*/
		$mensajeArchivo="";
