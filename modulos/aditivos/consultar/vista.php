    ...
    <div class="wrapper s">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Aditivos<small> Consulta</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Consultar aditivo</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['aditivos']['consultar']) or  !isset($_SESSION['permisos']['aditivos']['acceso'])){
