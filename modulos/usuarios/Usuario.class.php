...
class Usuario{
 //constructor	
	...
	function guardar($nombre,$email,$foto,$usuario,$contrasena,$estado,$idperfil,$empresa,$controlaracceso,$horainicio,$horafin,$idregistrorelacionado,$tablarelacionada,$bitacora){
		/////PERMISOS////////////////
		...
		if($this->con->conectar()==true){
			if($this->comprobarCampo("usuario",$usuario, "nuevo")){
				...
				if(mysqli_query($this->con->conect,"INSERT INTO usuarios (idusuario, nombre, email, foto, usuario, contrasena, estado, idperfil, empresa, controlaracceso, horainicio, horafin, idregistrorelacionado, tablarelacionada, bitacora) VALUES ('$idusuario','$nombre','$email','$foto','$usuario','$contrasena','$estado','$idperfil','$empresa','$controlaracceso','$horainicio','$horafin','$idregistrorelacionado','$tablarelacionada','$bitacora')")){
					//BITACORA
	...
	function actualizar($nombre,$email,$foto,$usuario,$contrasena,$estado,$idperfil,$empresa,$controlaracceso,$horainicio,$horafin,$idregistrorelacionado,$tablarelacionada,$bitacora,$idusuario){
		/////PERMISOS////////////////
