...
if($validacion){
	$resultado=$Ousuario->actualizar($nombre,$email,$foto,$usuario,$contrasena,$estado,$idperfil,$empresa,$controlaracceso,$horainicio,$horafin,$idregistrorelacionado,$tablarelacionada,$bitacora, $idusuario);
	if($resultado=="exito"){
		/*CARGAR ARCHIVOS*/
		$mensajeArchivo="";
