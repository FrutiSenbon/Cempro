		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">resistencia</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo resistencia</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar resistencia</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de resistencia</div>
				</a>
			</li>
			<?php }?>
