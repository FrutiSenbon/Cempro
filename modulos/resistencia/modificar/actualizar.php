  ...
  <body class="sidebar-mini <?php include("../../../componentes/skin.php");?>">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Resistencia<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Modificar resistencia</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['resistencia']['modificar']) or  !isset($_SESSION['permisos']['resistencia']['acceso'])){
	...
	/////FIN  DE PERMISOS////////
			...
			<?php include("../../../componentes/avisos.php");?>
          	...
          	<!-- Horizontal Form -->
            <div class="box box-info" style="border-color:#188305">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    <label for="ccantCemBom" class="col-sm-2 control-label">Cantidad de cemento bombeado</label>
                    <div class="col-sm-3">
                    	
                        <input value="<?php echo $cantCemBom; ?>" name="cantCemBom" type="text" class="form-control" id="ccantCemBom" />
				...
				<div class="form-group ">
                    <label for="ccantCemDir" class="col-sm-2 control-label">Cantidad de cemento directo</label>
                    <div class="col-sm-3">
                    	
                        <input value="<?php echo $cantCemDir; ?>" name="cantCemDir" type="text" class="form-control" id="ccantCemDir" />
                ...
                <div class="box-footer">
				  <input name="idResistencia" type="hidden" id="cidResistencia" value="<?php echo $id;?>"/>
                  <button type="button" class="btn btn-default" id="botonCancelar" onclick="vaciarCampos();">Limpiar</button>
                  <button type="button" class="btn btn-primary pull-right" id="botonGuardar"><i class="fa fa-save"></i>&nbsp;&nbsp;&nbsp;Guardar</button>
                </div><!-- /.box-footer -->
              </form>
              <div id="loading" class="overlay" style="display:none">
  					<i class="fa fa-cog fa-spin" style="color:#188305"></i>
			  </div>
