    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Resistencia<small>Nuevo registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Nuevo resistencia</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['resistencia']['guardar']) or  !isset($_SESSION['permisos']['resistencia']['acceso'])){
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input value="" name="cantCemBom" type="text" class="form-control" id="ccantCemBom" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input value="" name="cantCemDir" type="text" class="form-control" id="ccantCemDir" />
