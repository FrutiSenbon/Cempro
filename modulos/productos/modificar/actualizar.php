  ...
  <body class="sidebar-mini <?php include("../../../componentes/skin.php");?>">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Producto<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['productos']['modificar']) or  !isset($_SESSION['permisos']['productos']['acceso'])){
	...
	/////FIN  DE PERMISOS////////
			...
			<?php include("../../../componentes/avisos.php");?>
          	...
          	<!-- Horizontal Form -->
            <div class="box box-info" style="border-color:#cccc00">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                  	<label for="cuniMedEnt" class="col-sm-2 control-label">Unidad de medida de entrada: :</label>
                    <div class="col-sm-3">
                    	<select id="cuniMedEnt" name="uniMedEnt" class="form-control">
										<option value="M3" <?php 
											if ($uniMedEnt=="M3"){
				...
				<div class="form-group ">
                  	<label for="cuniMedSal" class="col-sm-2 control-label">Unidad de medida de salida:</label>
                    <div class="col-sm-3">
                    	<select id="cuniMedSal" name="uniMedSal" class="form-control">
										<option value="M3" <?php 
											if ($uniMedSal=="M3"){
												echo 'selected="selected"';
											}
				...
				<div class="form-group ">
                    <label for="cequivalencia" class="col-sm-2 control-label">Equivalencia:</label>
                    <div class="col-sm-3">
                    	
                        <input value="<?php echo $equivalencia; ?>" name="equivalencia" type="text" class="form-control" id="cequivalencia" />
                ...
                <div class="box-footer">
				  <input name="idCatalogo" type="hidden" id="cidCatalogo" value="<?php echo $id;?>"/>
                  <button type="button" class="btn btn-default" id="botonCancelar" onclick="vaciarCampos();">Limpiar</button>
                  <button type="button" class="btn btn-primary pull-right" id="botonGuardar"><i class="fa fa-save"></i>&nbsp;&nbsp;&nbsp;Guardar</button>
                </div><!-- /.box-footer -->
              </form>
              <div id="loading" class="overlay" style="display:none">
  					<i class="fa fa-cog fa-spin" style="color:#cccc00"></i>
			  </div>
