    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Empleado<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['empleados']['modificar']) or  !isset($_SESSION['permisos']['empleados']['acceso'])){
            ...
            <div class="box box-info" style="border-color:#986947">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                    	<span id="Vpuesto">
                        <input value="<?php echo $puesto; ?>" name="puesto" type="text" class="form-control" id="cpuesto" />
            			<span class="textfieldMaxCharsMsg">Se ha superado el número máximo de caracteres.</span>
					<span class="textfieldMinCharsMsg">No se cumple el mínimo de caracteres requerido.</span>
						<span class="textfieldRequiredMsg">Se necesita un valor.</span>
					</span>
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="<?php echo $domicilio; ?>" name="domicilio" type="text" class="form-control" id="cdomicilio" />
                ...
                <div class="box-footer">
				  <input name="idempleado" type="hidden" id="cidempleado" value="<?php echo $id;?>"/>
