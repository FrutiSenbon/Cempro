...
function comprobarReglas(){
	...
	if(recuperarCookie("mostrarNombreArchivo")=="si"){
		$('.Cnombre').show();
		$('#CheckNombre').attr('checked', true);
	}else if(recuperarCookie("mostrarNombreArchivo")=="no"){
		$('.Cnombre').hide();
		$('#CheckNombre').attr('checked', false);
	}
	//Mostrar u Ocultar Archivo
	if(recuperarCookie("mostrarArchivoArchivo")=="si"){
		$('.Carchivo').show();
		$('#CheckArchivo').attr('checked', true);
	}else if(recuperarCookie("mostrarArchivoArchivo")=="no"){
		$('.Carchivo').hide();
	...
	//Mostrar u Ocultar Idregistro
	if(recuperarCookie("mostrarIdregistroArchivo")=="si"){
		$('.Cidregistro').show();
		$('#CheckIdregistro').attr('checked', true);
	}else if(recuperarCookie("mostrarIdregistroArchivo")=="no"){
		$('.Cidregistro').hide();
		$('#CheckIdregistro').attr('checked', false);
	}
...
$(document).ready(function() {
	...
	$( "#CheckNombre" ).click(function() {
    	if ($( "#CheckNombre" ).is(':checked')){
			crearCookie("mostrarNombreArchivo", "si");
			$('.Cnombre').show();
		}else{
			crearCookie("mostrarNombreArchivo", "no");
			$('.Cnombre').hide();
		}	
	});
	$( "#CheckArchivo" ).click(function() {
    	if ($( "#CheckArchivo" ).is(':checked')){
			crearCookie("mostrarArchivoArchivo", "si");
			$('.Carchivo').show();
		}else{
			crearCookie("mostrarArchivoArchivo", "no");
			$('.Carchivo').hide();
		}	
	});
	...
	$( "#CheckIdregistro" ).click(function() {
    	if ($( "#CheckIdregistro" ).is(':checked')){
			crearCookie("mostrarIdregistroArchivo", "si");
			$('.Cidregistro').show();
		}else{
			crearCookie("mostrarIdregistroArchivo", "no");
			$('.Cidregistro').hide();
		}	
	});
