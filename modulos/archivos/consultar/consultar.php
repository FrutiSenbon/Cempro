...
$filasTotales = $Oarchivo->contar($busqueda, $papelera);
...
if ($tipoVista=="tabla"){ // Si se ha elegido el tipo tabla ?>
	<div class="box-body table-responsive no-padding"> <!-- /.box-body -->
    	<table class="table table-hover table-bordered">
        	<tr>
                ...
                <th class="columnaDecorada" style="background:#f3d66d;"></th>
				<th class="Cidarchivo">ID</th>
				<th class="Cnombre">Nombre del archivo</th>
				<th class="Carchivo">Archivo</th>
				<th class="Cidregistro">Asignación</th>
				<th width="40"></th>
                <th width="40"></th>
      		</tr>
	<?php
	while ($filas=mysqli_fetch_array($resultado)) { ?>
      		<tr id="iregistro<?php echo $filas['idarchivo'] ?>">
                ...
                <td class="columnaDecorada" style="background:#f3d66d;"></td>
                ...
                <td>
					...
					?>
						<form action="../modificar/actualizar.php?n1=catalogos&n2=archivos&n3=consultararchivos" method="post">
...
?>
	<div class="info-box" style="height:120px;" id="iregistro<?php echo $filas['idarchivo'] ?>">
    	<span class="info-box-icon bg-red" style="background-color:#f3d66d !important; height:120px; padding-top:15px;"><i class="fa fa-folder-open"></i></span>
    	<div class="info-box-content">
    		...
    		<span class="info-box-number Cnombre" style="font-weight:normal; color:#f3d66d;"><?php echo $filas['nombre'] ?></span>
            <span class="info-box-number Ccomposicion" style="font-weight:normal; font-size:12px;">
				...
				if (trim($filas['idregistro'])!=""){
					$composicion=$composicion.", Asignación: ".$filas['idregistro'];
				}
				echo $composicion;
				?>
			</span>
