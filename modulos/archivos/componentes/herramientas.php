          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
            ...
            <li><a>
            	<select id="campoOrden" class="form-control input-sm">
									...
									<option value="idregistro">Asignación</option>
                </select>
                </a>
    		</li>
            ...
            <li><span class="titulo-herramientas">Mostrar / Ocultar campos</span></li>
				...
				<li><a><input id="CheckArchivo" name="karchivo" value="si" checked="checked" type="checkbox"/><label for="CheckArchivo">&nbsp;&nbsp;Archivo</label></a></li>
			
				<li><a><input id="CheckFechamodificacion" name="kfechamodificacion" value="si" checked="checked" type="checkbox"/><label for="CheckFechamodificacion">&nbsp;&nbsp;Fecha de modificación</label></a></li>
			
				<li><a><input id="CheckIdregistro" name="kidregistro" value="si" checked="checked" type="checkbox"/><label for="CheckIdregistro">&nbsp;&nbsp;Asignación</label></a></li>
