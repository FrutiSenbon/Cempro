...
class Datofiscal{
 //constructor	
	...
	function armarConsulta($condicion,$papelera){
		if ($condicion!=""){
			if($papelera){
				$consulta="WHERE ((datosfiscales.idcliente LIKE '%".$condicion."%') OR (datosfiscales.domiciliocompleto LIKE '%".$condicion."%') OR (datosfiscales.formapago LIKE '%".$condicion."%') OR (datosfiscales.metodopago LIKE '%".$condicion."%') OR (datosfiscales.usocfdi LIKE '%".$condicion."%'))AND datosfiscales.estatus ='eliminado'";
			}else{
				$consulta="WHERE ((datosfiscales.idcliente LIKE '%".$condicion."%') OR (datosfiscales.domiciliocompleto LIKE '%".$condicion."%') OR (datosfiscales.formapago LIKE '%".$condicion."%') OR (datosfiscales.metodopago LIKE '%".$condicion."%') OR (datosfiscales.usocfdi LIKE '%".$condicion."%'))AND datosfiscales.estatus <>'eliminado'";
			}
		}else{
