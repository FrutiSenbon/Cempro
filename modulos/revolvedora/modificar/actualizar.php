  ...
  <body class="sidebar-mini <?php include("../../../componentes/skin.php");?>">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Revolvedora<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Modificar revolvedora</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['revolvedora']['modificar']) or  !isset($_SESSION['permisos']['revolvedora']['acceso'])){
	...
	/////FIN  DE PERMISOS////////
			...
			<?php include("../../../componentes/avisos.php");?>
          	...
          	<!-- Horizontal Form -->
            <div class="box box-info" style="border-color:#0c28af">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    <label for="cnumeroEconomico" class="col-sm-2 control-label">Numero economico:</label>
                    <div class="col-sm-3">
                    	<span id="VnumeroEconomico">
                        <input value="<?php echo $numeroEconomico; ?>" name="numeroEconomico" type="text" class="form-control" id="cnumeroEconomico" />
                ...
                <div class="box-footer">
				  <input name="idRevolvedora" type="hidden" id="cidRevolvedora" value="<?php echo $id;?>"/>
                  <button type="button" class="btn btn-default" id="botonCancelar" onclick="vaciarCampos();">Limpiar</button>
                  <button type="button" class="btn btn-primary pull-right" id="botonGuardar"><i class="fa fa-save"></i>&nbsp;&nbsp;&nbsp;Guardar</button>
                </div><!-- /.box-footer -->
              </form>
              <div id="loading" class="overlay" style="display:none">
  					<i class="fa fa-cog fa-spin" style="color:#0c28af"></i>
			  </div>
...
var sprytextfield1 = new Spry.Widget.ValidationTextField("VnumeroEconomico", "none", {validateOn:["blur"],  maxChars:10,  minChars:1});
				var sprytextfield1 = new Spry.Widget.ValidationTextField("VnumeroEconomico", "none", {validateOn:["blur"],  maxChars:10,  minChars:1});
