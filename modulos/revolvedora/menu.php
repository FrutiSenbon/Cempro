		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">revolvedora</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo revolvedora</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar revolvedora</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de revolvedora</div>
				</a>
			</li>
			<?php }?>
