		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">programacion</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo programacion</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar programacion</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de programacion</div>
				</a>
			</li>
			<?php }?>
