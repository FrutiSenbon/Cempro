...
if($validacion){
	$resultado=$Oprogramacion->guardar($vendedor,$cliente,$telCliente,$correoCliente,$tipoVialidad,$calle,$numero,$colonia,$resistencia,$aditivo,$valorAditivo,$mCubTotales,$revenimiento,$vertimiento,$fecha,$estatus);
	if($resultado=="exito"){
