		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">vendedores</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo vendedor</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar vendedores</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de vendedores</div>
				</a>
			</li>
			<?php }?>
