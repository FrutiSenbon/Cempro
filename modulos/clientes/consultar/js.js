...
function comprobarReglas(){
	...
	if(recuperarCookie("mostrarTelefonoCliente")=="si"){
		$('.Ctelefono').show();
		$('#CheckTelefono').attr('checked', true);
	}else if(recuperarCookie("mostrarTelefonoCliente")=="no"){
		$('.Ctelefono').hide();
		$('#CheckTelefono').attr('checked', false);
	}
	//Mostrar u Ocultar Correo
	if(recuperarCookie("mostrarCorreoCliente")=="si"){
		$('.Ccorreo').show();
		$('#CheckCorreo').attr('checked', true);
	}else if(recuperarCookie("mostrarCorreoCliente")=="no"){
		$('.Ccorreo').hide();
		$('#CheckCorreo').attr('checked', false);
	}
...
$(document).ready(function() {
	...
	$( "#CheckTelefono" ).click(function() {
    	if ($( "#CheckTelefono" ).is(':checked')){
			crearCookie("mostrarTelefonoCliente", "si");
			$('.Ctelefono').show();
		}else{
			crearCookie("mostrarTelefonoCliente", "no");
			$('.Ctelefono').hide();
		}	
	});
	$( "#CheckCorreo" ).click(function() {
    	if ($( "#CheckCorreo" ).is(':checked')){
			crearCookie("mostrarCorreoCliente", "si");
			$('.Ccorreo').show();
		}else{
			crearCookie("mostrarCorreoCliente", "no");
			$('.Ccorreo').hide();
		}	
	});
